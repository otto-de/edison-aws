...
import de.otto.edison.aws.dynamodb.togglz.DynamoTogglzRepository;
...
public class DynamoTogglzConfiguration {
    ...
    @Bean
    StateRepository stateRepository(final DynamoDBClient dynamoClient, final FeatureClassProvider featureClassProvider, final UserProvider userProvider) {
        LOG.info("===============================");
